...
//        }
//    }
//    shutDownError.value= viewModel.shutDownError.value
//    errorMessage.value = viewModel.errorMessage.value
//    if (showMessage.value)
//        updatePointsResponse(showMessage = showMessage, isSuccess = viewModel.isSuccess, viewModel.message)
//
//    Card(
//        modifier = Modifier
//            .clickable {
...
//    errorMessage.value = viewModel.errorMessage.value
//
//    if (viewModel.errors.value.isNotEmpty()) {
//        shutDown.value = true
